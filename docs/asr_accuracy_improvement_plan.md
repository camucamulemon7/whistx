...
- 短期文脈プロンプトと重要語抽出: [`server/runtime.py`](/home/remon1129/ai/whistx/server/runtime.py)
- overlap 重複除去と反復ノイズ抑制: [`server/runtime.py`](/home/remon1129/ai/whistx/server/runtime.py)
...
- [`server/runtime.py`](/home/remon1129/ai/whistx/server/runtime.py) の `LiveSession` と `_session_worker()` に failed chunk buffer を追加
...
- [`server/runtime.py`](/home/remon1129/ai/whistx/server/runtime.py) の `_build_prompt()` を `base_prompt`, `domain_terms`, `recent_context` の3層に分離
- [`server/runtime.py`](/home/remon1129/ai/whistx/server/runtime.py) の `_extract_context_terms()` を recency-weighted に改善
...
- [`server/runtime.py`](/home/remon1129/ai/whistx/server/runtime.py) の `_trim_overlap_prefix()` に SequenceMatcher を併用
- [`server/runtime.py`](/home/remon1129/ai/whistx/server/runtime.py) の `_is_near_duplicate()` に時間差条件を追加
...
- [`server/runtime.py`](/home/remon1129/ai/whistx/server/runtime.py) に `_light_proofread()` を追加
