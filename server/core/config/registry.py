...
ENV_REGISTRY = (
    ...
    spec("ASR_HIGH_ACCURACY_MAX_RT_LAG_SECONDS", "float", "2.0", ">=0.25"),
    spec("ASR_HIGH_ACCURACY_TIMEOUT_SECONDS", "float", "180.0", ">=1"),
    ...
    spec("LANGFUSE_ENABLED", "boolean", "0"),
    spec("LANGFUSE_CAPTURE_CONTENT", "boolean", "0"),
