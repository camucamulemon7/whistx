...
ENV_REGISTRY = (
    ...
    spec("WS_MAX_MESSAGE_BYTES", "integer", "20971520", ">=1024"),
    spec("WS_MAX_INVALID_MESSAGES", "integer", "3", ">=1"),
    spec("WS_SCREENSHOT_MAX_BYTES", "integer", "5242880", ">=1024"),
    spec("WS_PROMPT_MAX_CHARS", "integer", "8000", ">=256"),
    spec("WS_VOCABULARY_MAX_CHARS", "integer", "8000", ">=256"),
    spec("WS_TELEMETRY_MAX_CHARS", "integer", "4096", ">=256"),
    ...
    spec("DB_POOL_SIZE", "integer", "5", ">=1"),
    spec("DB_MAX_OVERFLOW", "integer", "10", ">=0"),
    spec("DB_POOL_TIMEOUT_SECONDS", "integer", "30", ">=1"),
    spec("DB_POOL_RECYCLE_SECONDS", "integer", "1800", ">=30"),
    spec("DB_POOL_PRE_PING", "boolean", "1"),
    spec("APP_SESSION_SECRET", "string", "", "at least 32 characters", secret=True),
    spec("APP_SESSION_DAYS", "integer", "7", ">=1"),
    spec("APP_PUBLIC_URL", "url", ""),
    spec("APP_TRUST_PROXY_HEADERS", "boolean", "0"),
    spec("APP_TRUSTED_PROXY_IPS", "csv", ""),
    spec("APP_ALLOWED_HOSTS", "csv", "localhost,127.0.0.1,[::1],testserver"),
    ...
    spec("ASR_WORKER_CONCURRENCY", "integer", "4", ">=1"),
    spec("MEDIA_WORKER_CONCURRENCY", "integer", "2", ">=1"),
    spec("LLM_WORKER_CONCURRENCY", "integer", "4", ">=1"),
    spec("DIARIZATION_WORKER_CONCURRENCY", "integer", "1", ">=1"),
    spec("ARTIFACT_WORKER_CONCURRENCY", "integer", "2", ">=1"),
    spec("BLOCKING_WORKER_QUEUE_TIMEOUT_SECONDS", "float", "30", ">=1"),
